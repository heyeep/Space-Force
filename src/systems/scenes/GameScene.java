...
public class GameScene extends Scene {
    ...
    private Explosion _e = new Explosion(100,100,3);
...
//        _e.setIcon(new ImageIcon("bubble_explo5.png"));
//        _e.setVisible(true);
//        this.add(_e);
//        this.explosions.add(_e);
//        
//        Explosion n = new Explosion(250,125,10);
//        this.add(n);
//        this.explosions.add(n);

//        exp.setIcon(new ImageIcon("bubble_explo1.png"));
//        exp.setVisible(true);
//        this.add(exp);
    ...
    private void addExplosion(int x, int y) {
        Explosion n = new Explosion(x,y,10);
        this.add(n);
        this.explosions.add(n);
    }
...
//        this.revalidate();
        System.out.println("DELETING AN EXPLOSION --------------------------");
    }
    private void manageExplosions(){
        Vector<Explosion> toDelete = new Vector<Explosion>();
        for (Explosion e : this.explosions) {
            System.out.println("Explosion ");
            boolean isDone = e.nextFrame();
            if (isDone) {
                toDelete.add(e);
            }
        }
        
        for(Explosion e: toDelete) {
            deleteExplosion(e);
        }
    }
...
//            _e.setLocation(50, 50);
//            _e.nextFrame();
//            
//            exp.setLocation(100, 100);
            ...
            for(JLabel lb : arr1){
                if(lb.getBounds().intersects(this.bullet.getBounds()))
                {
                    ...
                    scores++;
                    // explosion
//                    addExplosion(this.bullet.getX(), this.bullet.getY());
                }
